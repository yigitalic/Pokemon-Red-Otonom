...
from red_gym.data.elevators import NEXT_ELEVATORS
from red_gym.data.events import (
    EVENT_FLAGS_START,
    EVENTS_FLAGS_LENGTH,
    MUSEUM_TICKET,
    REQUIRED_EVENTS,
...
from red_gym.data.field_moves import FieldMoves
from red_gym.data.flags import Flags
from red_gym.data.items import (
    HM_ITEMS,
    KEY_ITEMS,
    MAX_ITEM_CAPACITY,
    REQUIRED_ITEMS,
...
from red_gym.data.map import (
    MAP_ID_COMPLETION_EVENTS,
    MapIds,
)
from red_gym.data.missable_objects import MissableFlags
from red_gym.data.party import PartyMons
from red_gym.data.strength_puzzles import STRENGTH_SOLUTIONS
from red_gym.data.tilesets import Tilesets
from red_gym.data.tm_hm import (
    CUT_SPECIES_IDS,
    STRENGTH_SPECIES_IDS,
    SURF_SPECIES_IDS,
    TmHmMoves,
)
from red_gym.global_map import GLOBAL_MAP_SHAPE, local_to_global
